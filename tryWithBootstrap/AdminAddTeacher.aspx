<%@ Page Title="" Language="C#" MasterPageFile="~/AdminDashboard.Master" AutoEventWireup="true" CodeBehind="AdminAddTeacher.aspx.cs" Inherits="tryWithBootstrap.WebForm3" %>
                            ...
                            <div class="user">
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <asp:TextBox CssClass="form-control form-control-user" ID="txtStaffID" placeholder="First Name" runat="server"></asp:TextBox>
                                    </div>
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                ...
                                <div class="form-group">
                                    <asp:TextBox CssClass="form-control form-control-user" ID="txtSubject" placeholder="Subject" runat="server"></asp:TextBox>
                                ...
                                <asp:Button CssClass="btn btn-primary btn-user btn-block" ID="btnAdd" runat="server" Text="Add Teacher" OnClick="btnAdd_Click" />
                                <hr />
